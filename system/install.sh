...
APT_PACKAGES='wget curl guake zsh emacs aptitude lxc xclip tmux meld git python3-pip python3-setuptools python3-streamlink python-is-python3 vim tree htop net-tools'
