;;; From: http://www.emacswiki.org/emacs/fic-mode.el
;;; Slightly modified
;;;
...
(defcustom fic-highlighted-words '("FIXME" "TODO" "BUG" "OPTIMIZE")
  "Words to highlight"
  :group 'fic-mode)
...
(defcustom fic-background-color "None"
...
;;;###autoload
(define-minor-mode fic-mode "highlight FIXME, TODO, BUG and OPTIMIZE in comments and strings"
